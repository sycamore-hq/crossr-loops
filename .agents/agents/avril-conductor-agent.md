...
6. `REJECT <id>` loops that id alone; unchanged siblings keep their BLESS. Re-run the three-adversary chain on the revised item (fresh blessings; prior BLESS does not carry after material change).
